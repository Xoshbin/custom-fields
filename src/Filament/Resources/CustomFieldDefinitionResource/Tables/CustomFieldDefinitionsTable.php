        ...
        return $table
            ->columns([
                TextColumn::make('name')
                    ->label(__('custom-fields::custom_fields.fields.name'))
                    ->searchable()
                    ->sortable()
                    ->weight('medium'),
                ...
                TextColumn::make('field_definitions')
                    ->label(__('custom-fields::custom_fields.fields.field_definitions'))
                    ->formatStateUsing(function (?array $state): string {
                        if (empty($state)) {
                            return __('custom-fields::custom_fields.messages.no_fields_defined');
                        }
                ...
                IconColumn::make('is_active')
                    ->label(__('custom-fields::custom_fields.fields.is_active'))
                    ->boolean()
                    ->sortable(),
